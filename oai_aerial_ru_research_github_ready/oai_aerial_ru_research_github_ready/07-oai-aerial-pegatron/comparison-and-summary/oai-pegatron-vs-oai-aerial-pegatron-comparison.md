...
| Item | OAI + Pegatron RU | OAI + cuBB for WNC RU | OAI + Ariel cuBB + Pegatron RU Attempt | Difference | Evidence | Status |
|---|---|---|---|---|---|---|
| System architecture |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| RU type / model |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| RU band |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| gNB config |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| frequency / bandwidth |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| numerology / SCS |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| TDD pattern |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| IP / port |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| clock / sync |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| fronthaul / eCPRI |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| antenna / gain |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| launch sequence |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| log location |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| success condition / E2E status |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |
| error / limitation |  |  |  |  |  | ☐ Confirmed ☐ Need Confirm |

## Key Findings

| Finding | Evidence | Impact | Next Step |
|---|---|---|---|
|  |  |  |  |
